...
def predict(model_stock_name, start_date, predict_range, type) -> list:
    ...
    # print(predicted)
    return {'predict': predicted, 'history': df}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--predict_range', help='How long you want to predict (days num)D (weeks num)W (months num)M\nD: Day\n W: Week\nM: Month', default=1)
